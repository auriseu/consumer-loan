import {AfterContentInit, Component, ContentChildren, EventEmitter, Injectable, Output, QueryList} from '@angular/core';
...
export class FormWizardComponent implements AfterContentInit {
  ...
  public next(): void {
    if (this.hasNextStep && this.activeStep.isValid && this.activeStep.isValidated) {
